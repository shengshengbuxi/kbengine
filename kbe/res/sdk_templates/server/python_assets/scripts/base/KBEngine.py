class EntityComponent:
    ...
    def addTimer(self, initialOffset, repeatOffset=0, userArg=0):
        """		
        调用owner的addTimer，功能说明看Entity.addTimer
        """
        pass

    def delTimer(self, id):
        """		
        调用owner的delTimer，功能说明看Entity.delTimer
        """
        pass
...
def createNewEntityByDB(  entityType, params={}, callback=None, shouldAutoLoad=-1, dbInterfaceName="default", writeConcern=False ):
    """
    功能说明：
    创建一个新的Entity实体，
...
def createEntity(  entityType, params ):
    """	
...
def createNewEntityAnywhereByDB(  entityType, params={}, callback=None, shouldAutoLoad=-1, dbInterfaceName="default", writeConcern=False ):
    """
    功能说明：
    创建一个新的Entity实体，
