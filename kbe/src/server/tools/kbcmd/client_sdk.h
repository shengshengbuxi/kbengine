...
public:
	...
	virtual bool copyPluginsSourceToPath(const std::string& path, const std::string& spaceName);
	...
	virtual bool writeTypeItemType_TEXT(const std::string& itemName, const std::string& childItemName, const std::string& des)
	{
		return false;
	}
